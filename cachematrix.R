## These two functions try to incrase the speed of the calculation of a matrix inverse by caching the 
##inverse matrix
 

## This function creates a special "matrix" object that can cache its inverse.
## (It assume that the supplied matrix (x) is always invertable)
